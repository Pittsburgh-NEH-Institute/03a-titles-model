...
![exist-db CI](https://github.com/djbpitt/03a-titles-model/workflows/exist-db%20CI/badge.svg)
...
1.  Download  the `03a-titles-model-1.0.0.xar` file from GitHub [releases](https://github.com/djbpitt/03a-titles-model/releases) page.
...
If you see `BUILD SUCCESSFUL` ant has generated a `03a-titles-model-1.0.0.xar` file in the `build/` folder. To install it, follow the instructions [above](#installation).
...
[release-url]: https://github.com/djbpitt/03a-titles-model/releases/latest
